...
CURATED_METHODS = {
    ...
    "distMapExtrude": get_vxlImg_func_args("distMapExtrude"), 
    "vxlToFoam":  get_vxlImg_func_args("vxlToFoam"),  
    "vxlToFoamPar": get_vxlImg_func_args("vxlToFoamPar"), 
    "vxlToFoamPar_seq": get_vxlImg_func_args("vxlToFoamPar_seq"), 
    "vxlToSurfMesh": get_vxlImg_func_args("vxlToSurfMesh"), 
    "printInfo": get_vxlImg_func_args("printInfo"), 
    "write": get_vxlImg_func_args("write"), 
    "writeNoHeader": get_vxlImg_func_args("writeNoHeader"), 
    "readAscii": get_vxlImg_func_args("readAscii"), 
    "growBox": get_vxlImg_func_args("growBox"), 
    "shrinkBox": get_vxlImg_func_args("shrinkBox"), 
    "fillHoles": get_vxlImg_func_args("fillHoles"), 
    "threshold101": get_vxlImg_func_args("threshold101"), 
    "writeAConnectedPoreVoxel": get_vxlImg_func_args("writeAConnectedPoreVoxel"), 
    "AND": get_vxlImg_func_args("AND"), 
    "NOT": get_vxlImg_func_args("NOT"), 
    "OR": get_vxlImg_func_args("OR"),  
    "XOR": get_vxlImg_func_args("XOR"), 
    "resampleMode": get_vxlImg_func_args("resampleMode"), 
    "resampleMax": get_vxlImg_func_args("resampleMax"), 
    "resampleMean": get_vxlImg_func_args("resampleMean"), 
    "resliceZ": get_vxlImg_func_args("resliceZ"), 
    "paint": get_vxlImg_func_args("paint"), 
    "paintAdd": get_vxlImg_func_args("paintAdd"), 
    "paintBefore": get_vxlImg_func_args("paintBefore"), 
    "paintAfter": get_vxlImg_func_args("paintAfter"), 
    "paintAddBefore": get_vxlImg_func_args("paintAddBefore"), 
    "paintAddAfter": get_vxlImg_func_args("paintAddAfter"), 
    "writeContour": get_vxlImg_func_args("writeContour"), 
    "plotSlice": get_vxlImg_func_args("plotSlice"), 
    "writeContour": get_vxlImg_func_args("writeContour"),  
    "plotSlice": get_vxlImg_func_args("plotSlice"),   
    "rescaleValues": get_vxlImg_func_args("rescaleValues"),  
    ...
    "rangeTo": get_vxlImg_func_args("rangeTo"), 
    "replaceRange": get_vxlImg_func_args("replaceRange"), 
    "write8bit": get_vxlImg_func_args("write8bit"), 
    "readFromHeader": get_vxlImg_func_args("readFromHeader"), 
    "readBin": get_vxlImg_func_args("readBin"), 
    "modeNSames": get_vxlImg_func_args("modeNSames"), 
    "medianFilter": get_vxlImg_func_args("medianFilter"), 
    "medianX": get_vxlImg_func_args("medianX"), 
    "medianY": get_vxlImg_func_args("medianY"), 
    "medianZ": get_vxlImg_func_args("medianZ"), 
    "FaceMedian06": get_vxlImg_func_args("FaceMedian06"), 
    "pointMedian032": get_vxlImg_func_args("pointMedian032"), 
    "faceMedNgrowToFrom": get_vxlImg_func_args("faceMedNgrowToFrom"), 
    "delense032": get_vxlImg_func_args("delense032"), 
    "circleOut": get_vxlImg_func_args("circleOut"), 
    "growLabel": get_vxlImg_func_args("growLabel"), 
    "keepLargest": get_vxlImg_func_args("keepLargest"), 
    "mapFrom": get_vxlImg_func_args("mapFrom"), 
    "addSurfNoise": get_vxlImg_func_args("addSurfNoise"),  
    "averageWith": get_vxlImg_func_args("averageWith"), 
    "averageWith_mBE": get_vxlImg_func_args("averageWith_mBE"), 
    "plotAll": get_vxlImg_func_args("plotAll"), 
    "mode26": get_vxlImg_func_args("mode26"), 
    "growingThreshold": get_vxlImg_func_args("growingThreshold"), 
    "replaceOutSideValue": get_vxlImg_func_args("replaceOutSideValue"), 
    "smooth": get_vxlImg_func_args("smooth"), 
    "plotHistogramSvg": get_vxlImg_func_args("plotHistogramSvg"), 
    "plotZProfileSvg": get_vxlImg_func_args("plotZProfileSvg"), 
    "flipEndian": get_vxlImg_func_args("flipEndian"), 
    "replaceRangeByImage": get_vxlImg_func_args("replaceRangeByImage"), 
    "replaceByImageRange": get_vxlImg_func_args("replaceByImageRange"), 
    "readFromFloat": get_vxlImg_func_args("readFromFloat"), 
    "bilateralX": get_vxlImg_func_args("bilateralX"), 
    "bilateralGauss": get_vxlImg_func_args("bilateralGauss"), 
    "meanWide": get_vxlImg_func_args("meanWide"), 
    "otsu_threshold": get_vxlImg_func_args("otsu_threshold"), 
    "dering": get_vxlImg_func_args("dering"), 
    "adjustBrightnessWith": get_vxlImg_func_args("adjustBrightnessWith"), 
    "adjustSliceBrightness": get_vxlImg_func_args("adjustSliceBrightness"), 
    "cutOutside": get_vxlImg_func_args("cutOutside"), 
